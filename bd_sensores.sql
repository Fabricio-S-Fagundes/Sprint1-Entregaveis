...
alter table vinhs add constraint chkVinho check (tipoVinho in ('Suave', 'Branco','Espumante','Tinto'));


insert into vinhos (tipoVinho,tempIdeal) values
('Suave','14'),
('Branco','10'),
('Espumante','9'),
('Tinto','18');
...
select tempIdeal from vinhos where tipoVinho like '%Tinto%';

select * from vinhos where tempIdeal < 10;
